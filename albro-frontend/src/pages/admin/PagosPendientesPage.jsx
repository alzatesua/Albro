...
import { getPagosPendientesAdmin, verificarPagoAdmin } from "@/services/api";
import {
  RefreshCw,
  FileText,
  Loader2,
...
export default function PagosPendientesPage() {
  ...
  const manejarConfirmar = async () => {
    ...
    setError("");
    try {
      await verificarPagoAdmin({
        email: pagoAConfirmar.usuario_email,
        monto: Number(pagoAConfirmar.monto),
        plan: pagoAConfirmar.plan,
        pago_id: pagoAConfirmar.id,  
      });
